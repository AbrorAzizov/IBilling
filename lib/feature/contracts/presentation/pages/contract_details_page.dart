        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _DetailRow(label: 'Status of the contract:', value: contract.status.name, isStatus: true),
                    ...
                    _DetailRow(
                      label: 'Created at:',
                      value: '${contract.createdAt.hour}:${contract.createdAt.minute}, ${contract.createdAt.day} February, ${contract.createdAt.year}',
                    ),
                  ],
                ),
              ),
                ...
                children: [
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        context.read<ContractsBloc>().add(DeleteContractRequested(contract.id));
                      },
              ...
              // Mocking "Other contracts" using the same contract for UI demo
