...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String currentFlag = 'assets/flags/en.svg';
    if (locale == 'uz') {
      currentLangText = l10n.uzbek;
      currentFlag = 'assets/flags/uz.svg';
    } else if (locale == 'ru') {
      currentLangText = l10n.russian;
      currentFlag = 'assets/flags/ru.svg';
    }
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Spacer(),
                    SvgPicture.asset(currentFlag, width: 24),
                  ],
                ),
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            SvgPicture.asset(flag, width: 24),
            const SizedBox(width: 12),
            Text(
              title,
              style: const TextStyle(color: Colors.white, fontSize: 14),
